...
<div class="container-fluid home-start">
	<div class="row">
		...
		<div class="col-12 home-start-text">
			<div>
				<p class="slogan">BUILD YOUR OWN EMPIRE</p>
		...
		<div class="row justify-content-start">
			<div class="col-12 col-lg-6 col-xl-lg-5">
				...
				<form class="mailform" action="" method="post">
					@csrf
					<input class="mailform-input" type="text" name="name" id="name" placeholder="Name">
